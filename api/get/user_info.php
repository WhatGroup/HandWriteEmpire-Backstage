<?php
    ...
    function getData($id,$account){
        $query_userInfo=mysql_query("SELECT userName,portraitPath,attackValue,defenseValue,cureValue,userLevelInfosPath,userErrorWordInfosPath FROM user_info WHERE userId='{$id}'") 
            or die('Mysql错误！'.mysql_error());
